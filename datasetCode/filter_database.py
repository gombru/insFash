...
filtered_jsons_dir = "../../../hd/datasets/instaFashion/json_filtered/"
output_file_path = "../../../hd/datasets/instaFashion/captions.json"
...
users_blacklist = []
users_blacklist_file = open("../../../hd/datasets/instaBarcelona/users_blacklist150.txt", "r")
